...
def blurImg(img,ksize=(5,5)): #Averaging adjency pixsel 5x5 size kernel
    return cv2.blur(img, ksize)

def gaussianBlurImg(img, ksize=(5,5)): #Gaussian Blurring
    kernel = cv2.getGaussianKernel(ksize[0],0)
